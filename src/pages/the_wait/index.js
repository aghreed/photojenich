  ...
  <div className="the-wait-container">
    ...
    <section className="segway" style={{ background: `${TheWaitBackgroundColor}`}}>
      <div className="observations-insights-container">
        ...
        <div className="bullet-list-container">
          ...
          <div className="item">
            <div className="bar"></div>
            <div className="text">People waiting feel forced to stay close to the waiting room due to tools and out of date procedures hospitals use to notify loved ones.</div>
          </div>
          <div className="item">
            <div className="bar"></div>
    ...
    <div className="secondary-research-container">
      <div className="article-container">
        ...
        <p className="text">
        We sought to understand the timeline of a surgery through secondary research and the possible stressors the support system may run into along the way. I came up with my own research model to help me better understand the anxieties that come with each phase of the surgery timeline. Once privy to each stage, my team and I decided to streamline the process from “getting there” to the “hospital departure.”
        </p>
      </div>
    </div>
    </section>
    ...
    <ParagraphImage
      ...
      title="Validation through Primary Research"
    ...
    <section className="insights-section">
      <div className="insights-container">
        ...
        <div className="insights-description">
          <h4 className="insights-title">Testing the Experience</h4>
          <p className="text">
          To understand our service concept in a holistic way, we set off on conducting a rapid experience prototype. We had three participants go through the different touchpoints within our service and experience and give us feedback at the end.
          </p>
        </div>
      </div>
    </section>
    ...
    <SingleTitledParagraph
      title="Feedback from our Service Walkthrough"
      text="Overall our feedback from our service walkthrough was positive; our participants felt comforted by the idea that they would be taken care of during their loved one’s surgery too. Our primary source of feedback was to be extra sensitive about the information we were giving to the support system and inform the support system about what to expect, so they are ready for the experience as a whole. With this information, we made three iterations upon our first version of our experience design."
    />
    <SegwayBulletList
      title="Iterations"
    ...
    <section className="inform-section">
      <div className="inform-container">
        ...
        <div className="inform-description">
          ...
          “I would love to be in the loop of what my family is doing. The more information, the better.” – Service Walkthrough Participant 1
          </p>
    ...
    <SingleTitledParagraph
      ...
      text="Integrating into healthcare software systems already in use, Care would send updates during significant milestones of the surgery experience. With a timeline always on the home page, we show the information the support system will receive so they won’t be surprised or worried about what the next update could be. Push notifications for when doctor check-ins are going to happen will also be sent, giving waiters the freedom to move around and know they will not miss anything."
    />
    <section className="staying-in-the-loop-section">
      <div className="staying-in-the-loop-container">
    ...
    <SingleTitledParagraph
      ...
      text="Other features, like a two-step authentication process through the patient, ensure privacy and security for the application and the patient."
    />
    <UISpecs
      projectKey="the_wait"
